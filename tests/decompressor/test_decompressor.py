...
def test_decompress():
    ...
    valid_buffer: Buffer = Buffer(content=valid_stack_packet, bit_length=8*len(valid_stack_packet), padding=Padding.RIGHT)
    ...
    decompressed_packet = decompress(schc_packet=schc_packet, direction=DirectionIndicator.UP, rule=rule_descriptor_1)
