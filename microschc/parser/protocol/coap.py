...
class CoAPOptionParser(HeaderParser):
    
    def __init__(self) -> None:
        super().__init__(COAP_HEADER_ID)
    ...
    def parse(self, buffer: bytes) -> HeaderDescriptor:
        ...
        while buffer[cursor] != 0xff:
            ...
            option_cursor: int = 1 # to keep track of variable length fields
            ...
            if option_length == CoAPDefinitions.OPTION_LENGTH_EXTENDED_8BITS:
                ...
                option_length_extended: int = option_bytes[option_cursor]
                ...
                option_length_extended: int = (option_bytes[option_cursor] << 8) & option_bytes[option_cursor+1]
            ...
            option_cursor += option_length + option_length_extended # position of option value
